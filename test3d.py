...
test_paths = [['G:/Datasets/elderlymen1/3ddownsampled/test/images','G:/Datasets/elderlymen2/3ddownsampled/image', 'G:/Datasets/youngmen/3ddownsampled/image', 'G:/Datasets/elderlywomen/3ddownsampled/image'],
              ['G:/Datasets/elderlymen1/3ddownsampled/test/masks','G:/Datasets/elderlymen2/3ddownsampled/mask', 'G:/Datasets/youngmen/3ddownsampled/mask', 'G:/Datasets/elderlywomen/3ddownsampled/mask']]
...
data_gen_args = data_gen_args_dict = dict(shear_range=30,
                    ...
                    zoom_range = 0.1,
                    fill_mode='nearest')
train_images_path = 'C:/fascia3dtest/train/images'
train_masks_path = 'C:/fascia3dtest/train/masks'
all_frames = os.listdir('C:/fascia3dtest/train/images')
gen = generator3da(all_frames, train_images_path, train_masks_path, to_fit=True,batch_size=1, patch_size=8, dim=(128, 128), dimy =(128,128), n_channels=1, n_classes=1, shuffle=True, data_gen_args = data_gen_args)

val_images_path = 'C:/fascia3dtest/val/images'
val_masks_path = 'C:/fascia3dtest/val/masks'
all_frames = os.listdir('C:/fascia3dtest/val/images')
genAug = generator3d(all_frames, val_images_path, val_masks_path, to_fit=True,batch_size=1, patch_size=8, dim=(128, 128), dimy =(128,128), n_classes=1, shuffle=True)

test_images_path = 'C:/fascia3dtest/test/images'
test_masks_path = 'C:/fascia3dtest/test/masks'
all_frames = os.listdir('C:/fascia3dtest/test/images')
...
history = model.fit_generator(generator=gen, validation_data=genAug, validation_steps=6, steps_per_epoch=60, epochs=100, callbacks=[model_checkpoint2,model_checkpoint])
